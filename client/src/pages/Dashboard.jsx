      ...
      <main className="max-w-7xl mx-auto p-4 md:p-8">
        {error && (
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4" role="alert">
            ...
            <button onClick={() => setError('')} className="absolute top-0 bottom-0 right-0 px-4 py-3 text-red-700">
              &times;
            </button>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            <AccountSummary transactions={transactions} className="" />
              ...
              <div className="flex flex-col gap-1 flex-grow overflow-hidden">
                    ...
                    {transactions.slice(0, 3).map((tx) => (
                      ...
                      >
                        <div className="flex-grow mr-2 overflow-hidden">
                          <strong className="font-medium text-gray-800 block truncate text-base">
                        ...
                        <div className="flex items-center flex-shrink-0 gap-3">
                          <div
                            className={`font-semibold text-base mr-1 whitespace-nowrap ${
                ...
                {transactions.length > 3 && (
                  <div className="text-center mt-auto pt-3">
                    <Link to="/transactions" className="text-indigo-600 hover:text-indigo-800 font-medium text-sm">
        ...
        <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Add New Transaction">
          <TransactionForm onTransactionAdded={handleTransactionAdded} onClose={() => setIsModalOpen(false)} />
        </Modal>
      </main>
    </div>
  );
